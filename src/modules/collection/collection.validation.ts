import { z } from 'zod';
import { SUPPORTED_LANGUAGES } from './collection.types';
import { paginationQuerySchema } from '../../shared/pagination/pagination.validation';

const slugRegex = /^[a-z0-9-]+$/;
const coverImageRegex = /^content\/collections\/.*$/;
...
export const createCollectionSchema = z.object({
  body: z.object({
    ...
    coverImageKey: z
      .string()
      .regex(coverImageRegex, 'Cover image key must start with content/collections/')
      .optional(),
